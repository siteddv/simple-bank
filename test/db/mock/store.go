...
// Source: github.com/siteddv/simple-bank/db/sqlc (interfaces: Store)
...
func (m *MockStore) AddAccountBalance(arg0 context.Context, arg1 db2.AddAccountBalanceParams) (db2.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetAccount(arg0 context.Context, arg1 int64) (db2.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetAccountForUpdate(arg0 context.Context, arg1 int64) (db2.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetEntry(arg0 context.Context, arg1 int64) (db2.Entry, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetTransfer(arg0 context.Context, arg1 int64) (db2.Transfer, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) UpdateAccount(arg0 context.Context, arg1 db2.UpdateAccountParams) (db2.Account, error) {
	m.ctrl.T.Helper()
